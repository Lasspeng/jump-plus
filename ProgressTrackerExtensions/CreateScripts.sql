...
INSERT INTO messages values(null, 3, 2, 'How are you doing today?', NOW());
INSERT INTO messages values(null, 1, 2, 'Hi', NOW());
INSERT INTO messages values (null, 2, 3, 'Im doing fine', NOW());
SELECT * FROM messages;
SELECT * FROM messages WHERE (sender_id = 3 AND recipient_id = 2) OR (sender_id = 2 AND recipient_id = 3) ORDER BY date_created ASC;
DROP TABLE messages;
